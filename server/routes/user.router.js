...
router.post('/images-quiz-total', (req, res) => {
  const userId = req.body.userId;
  const quizTotal = req.body.quizTotal;
  let queryText = `UPDATE "user"
  SET images_results = $1
  WHERE id = $2;`
  pool.query(queryText, [quizTotal, userId])
    .then(() => {
      res.sendStatus(201)
...
router.post('/links-quiz-total', (req, res) => {
  const userId = req.body.userId;
  const quizTotal = req.body.quizTotal;
  let queryText = `UPDATE "user"
  SET links_results = $1
...
router.post('/forms-quiz-total', (req, res) => {
  const userId = req.body.userId;
  const quizTotal = req.body.quizTotal;
  let queryText = `UPDATE "user"
  SET forms_results = $1
...
router.post('/tables-quiz-total', (req, res) => {
  const userId = req.body.userId;
  const quizTotal = req.body.quizTotal;
  let queryText = `UPDATE "user"
  SET tables_results = $1
  WHERE id = $2;`
  pool.query(queryText, [quizTotal, userId])
    .then(() => {
      res.sendStatus(201)
